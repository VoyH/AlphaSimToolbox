function [fALFFBrain, Header]=infodr_fALFF(AllVolume,outfile_fALFF,infile_Mask,Parameter)
%-----------------------------------------------------------
%   Copyright(c) 2015
...
[fALFFBrain, Header]=rp_falff(AllVolume,...
                           ASamplePeriod, ALowPass_HighCutoff, AHighPass_LowCutoff, ...
                           infile_Mask,outfile_fALFF, ...
                           '', '', '', CUTNUMBER);
...
function [fALFFBrain, Header] = rp_falff(AllVolume,ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename,AResultFilename, TemporalMask, ScrubbingMethod, Header, CUTNUMBER)
...
% FORMAT    rp_falff(AllVolume,ASamplePeriod, HighCutoff, LowCutoff, AMaskFilename,AResultFilename, TemporalMask, ScrubbingMethod, Header, CUTNUMBER)
% Input:
...
paddedLength = 2^nextpow2(sampleLength); %jiaxize 150808
...
% Detrend before fft as did in the previous rp_falff.m
...
rp_writefile(single(fALFFBrain), ...
    AResultFilename, ...
