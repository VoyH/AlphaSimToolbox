function varargout = rp_NormalityTest_gui(varargin)
%   varargout = rp_NormalityTest_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rp_NormalityTest_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rp_NormalityTest_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function rp_NormalityTest_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for rp_NormalityTest_gui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

function varargout = rp_NormalityTest_gui_OutputFcn(hObject, eventdata, handles) 
...
function RecursiveAddDataDir(hObject, eventdata, handles)
	...
	if ischar(theDir),
		...
		try
			rp_RecursiveDir(theDir, 'rp_NormalityTest_gui(''SetDataDir'',gcbo, ''%s'', guidata(gcbo) )');
		catch
...
function InitControlProperties(hObject, handles)
	...
	uimenu(handles.hContextMenu, 'Label', 'Remove selected directory', 'Callback', 'rp_RegressOutCovariates_gui(''DeleteSelectedDataDir'',gcbo,[], guidata(gcbo))');
