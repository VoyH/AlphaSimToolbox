function outpoints = rp_tal2mni(inpoints)
...
rotn = rp_spm_matrix([0 0 0 0.05]);
upz = rp_spm_matrix([0 0 0 0 0 0 0.99 0.97 0.92]);
downz = rp_spm_matrix([0 0 0 0 0 0 0.99 0.97 0.84]);
