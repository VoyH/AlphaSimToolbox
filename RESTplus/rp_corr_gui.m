function varargout = rp_corr_gui(varargin)
%   varargout = rp_corr_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rp_corr_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rp_corr_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function rp_corr_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rp_corr_gui_OutputFcn(hObject, eventdata, handles)
...
%     drawnow;
rp_corr_Image(DependentDirs,SeedSeries,OutputName,...
...
uimenu(handles.hContextMenu, 'Label', 'Remove selected group', 'Callback', 'rp_corr_gui(''DeleteSelectedG'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenu, 'Label', '=============================');
uimenu(handles.hContextMenu, 'Label', 'Remove all data groups', 'Callback', 'rp_corr_gui(''ClearG'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rp_corr_gui(''DeleteSelectedIC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rp_corr_gui(''ClearIC'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rp_corr_gui(''DeleteSelectedOC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rp_corr_gui(''ClearOC'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected seed variate', 'Callback', 'rp_corr_gui(''DeleteSelectedSeedSeries'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all seed variate', 'Callback', 'rp_corr_gui(''ClearSeedSeries'',gcbo,[], guidata(gcbo))');
