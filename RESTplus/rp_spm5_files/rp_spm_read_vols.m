function [Y,XYZ] = rp_spm_read_vols(V,mask)
% Read in entire image volumes
% FORMAT [Y,XYZ] = rp_spm_read_vols(V,mask)
...
% Andrew Holmes
% $Id: rp_spm_read_vols.m 5731 2013-11-04 18:11:44Z guillaume $

%for RESTplus, replaced by Jia Xi-Ze 20160113(SPM12)
