function varargout = rp_ttestpaired_gui(varargin)
%   varargout = rp_ttestpaired_gui(varargin)
%   Paired T-Test GUI.
...
%	Version=1.0;
%	Release=200100401;
%  Modified by JIA Xi-Ze 150829 support effect size
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rp_ttestpaired_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rp_ttestpaired_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function rp_ttestpaired_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rp_ttestpaired_gui_OutputFcn(hObject, eventdata, handles)
...
% rp_es_paired_Image(DependentDirs,OutputName,MaskFile);%150829 add by Jia Xi-ze
rp_ttestpaired_Image(DependentDirs,OutputName,MaskFile);
...
uimenu(handles.hContextMenu, 'Label', 'Remove selected group', 'Callback', 'rp_ttestpaired_gui(''DeleteSelectedG'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenu, 'Label', '=============================');
uimenu(handles.hContextMenu, 'Label', 'Remove all data groups', 'Callback', 'rp_ttestpaired_gui(''ClearG'',gcbo,[], guidata(gcbo))');
