function varargout = rp_ttest1_gui(varargin)
%   varargout = rp_ttest1_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rp_ttest1_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rp_ttest1_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function rp_ttest1_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rp_ttest1_gui_OutputFcn(hObject, eventdata, handles)
...
%     drawnow;
rp_ttest1_Image(DependentDirs,OutputName,MaskFile,Base);
...
uimenu(handles.hContextMenu, 'Label', 'Remove selected group', 'Callback', 'rp_ttest1_gui(''DeleteSelectedG'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenu, 'Label', '=============================');
uimenu(handles.hContextMenu, 'Label', 'Remove all data groups', 'Callback', 'rp_ttest1_gui(''ClearG'',gcbo,[], guidata(gcbo))');
