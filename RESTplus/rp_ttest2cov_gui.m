function varargout = rp_ttest2cov_gui(varargin)
%   varargout = rp_ttest2cov_gui(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @rp_ttest2cov_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @rp_ttest2cov_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
function rp_ttest2cov_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = rp_ttest2cov_gui_OutputFcn(hObject, eventdata, handles)
...
%     drawnow;
rp_ttest2cov_Image(DependentDirs,OutputName,...
...
uimenu(handles.hContextMenu, 'Label', 'Remove selected group', 'Callback', 'rp_ttest2cov_gui(''DeleteSelectedG'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenu, 'Label', '=============================');
uimenu(handles.hContextMenu, 'Label', 'Remove all data groups', 'Callback', 'rp_ttest2cov_gui(''ClearG'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rp_ttest2cov_gui(''DeleteSelectedIC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rp_ttest2cov_gui(''ClearIC'',gcbo,[], guidata(gcbo))');
...
uimenu(handles.hContextMenui, 'Label', 'Remove selected covariate', 'Callback', 'rp_ttest2cov_gui(''DeleteSelectedOC'',gcbo,[], guidata(gcbo))');
uimenu(handles.hContextMenui, 'Label', '=============================');
uimenu(handles.hContextMenui, 'Label', 'Remove all covariates', 'Callback', 'rp_ttest2cov_gui(''ClearOC'',gcbo,[], guidata(gcbo))');
