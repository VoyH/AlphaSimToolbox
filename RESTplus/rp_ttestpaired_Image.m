function [TTestPaired_T]=rp_ttestpaired_Image(DependentDirs,OutputName,MaskFile)
% [TTestPaired_T]=rp_ttestpaired_Image(DependentDirs,OutputName,MaskFile)
...
rp_writefile(TTestPaired_T,OutputName,[nDim1,nDim2,nDim3],VoxelSize, Header,'double');
% rp_WriteNiftiImage(TTestPaired_T,Header,OutputName);
